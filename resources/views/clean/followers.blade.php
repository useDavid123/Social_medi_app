        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    <h1 class="intro-lead">  Followers</h1>
    ...
    <div id="fh5co-portfolio">
        ...
        <div class="fh4co-portfolio-item ">
            ...
            <div class="fh4co-portfolio-description">
               ...
               @foreach($logs->followers as $log)
                    @if ( $log->id !==request()->session()->get("user_id")  )
                        <li class="notification-box bg-white">
                            <div class="row">
                                <div class="col-lg-3 col-sm-3 col-3 text-center">
                                    @if ($log->media_id == null )
                                        <img src="{{URL::asset("images/avartar3.jpg")}}" width="80" height="80" style="border-radius:50%">

                                    @else
                                        <img src="{{Storage::url($log->medias->media_path)}}" width="80" height="80" style="border-radius:50%">
                                    @endif

                                </div>

                                    <a href="/posts/signIn/pairs/{{$log->id}}"> <strong class="text-info">{{$log->username}}<br></strong></a>
                                    <b>{{$log->fullname}}</b>
                                <div>
